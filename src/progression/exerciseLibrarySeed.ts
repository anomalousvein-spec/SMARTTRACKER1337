...
export async function seedExerciseLibrary() {
  ...
  try {
    const defaultExercises: Omit<Exercise, 'id' | 'createdAt'>[] = [
      ...
      { name: "Dumbbell Bench Press", primaryMuscles: ["chest"], secondaryMuscles: ["triceps", "shoulders"], category: "Dumbbell", movementPattern: "Push", difficulty: "Beginner", isCustom: false },
      ...
      { name: "Incline Smith Machine Press", primaryMuscles: ["chest"], secondaryMuscles: ["shoulders", "triceps"], category: "Machine", movementPattern: "Push", difficulty: "Intermediate", isCustom: false },
      ...
      { name: "Machine Row", primaryMuscles: ["back"], secondaryMuscles: ["biceps", "shoulders"], category: "Machine", movementPattern: "Pull", difficulty: "Beginner", isCustom: false },
      ...
      { name: "Lat Pulldown (Machine)", primaryMuscles: ["back"], secondaryMuscles: ["biceps"], category: "Machine", movementPattern: "Pull", difficulty: "Beginner", isCustom: false },
      ...
      { name: "Dumbbell Romanian Deadlift", primaryMuscles: ["hamstrings"], secondaryMuscles: ["glutes", "back"], category: "Dumbbell", movementPattern: "Hinge", difficulty: "Beginner", isCustom: false },
      { name: "Smith Machine Good Morning", primaryMuscles: ["hamstrings"], secondaryMuscles: ["back", "glutes"], category: "Machine", movementPattern: "Hinge", difficulty: "Intermediate", isCustom: false },
      ...
      { name: "Pec Deck", primaryMuscles: ["chest"], secondaryMuscles: ["shoulders"], category: "Machine", movementPattern: "Push", difficulty: "Beginner", isCustom: false },
      { name: "Hammer Strength Chest Press", primaryMuscles: ["chest"], secondaryMuscles: ["triceps", "shoulders"], category: "Machine", movementPattern: "Push", difficulty: "Intermediate", isCustom: false },
      { name: "Dumbbell Incline Fly", primaryMuscles: ["chest"], secondaryMuscles: ["shoulders"], category: "Dumbbell", movementPattern: "Push", difficulty: "Intermediate", isCustom: false },
      { name: "Smith Machine Decline Press", primaryMuscles: ["chest"], secondaryMuscles: ["triceps", "shoulders"], category: "Machine", movementPattern: "Push", difficulty: "Intermediate", isCustom: false },
      ...
      { name: "Goblet Squat", primaryMuscles: ["quads"], secondaryMuscles: ["glutes", "hamstrings"], category: "Dumbbell", movementPattern: "Squat", difficulty: "Beginner", isCustom: false },
      ...
      { name: "V-Bar Pulldown", primaryMuscles: ["back"], secondaryMuscles: ["biceps"], category: "Machine", movementPattern: "Pull", difficulty: "Beginner", isCustom: false },
      { name: "Single Arm Lat Pulldown", primaryMuscles: ["back"], secondaryMuscles: ["biceps"], category: "Cable", movementPattern: "Pull", difficulty: "Intermediate", isCustom: false },
      { name: "Chest Supported Row", primaryMuscles: ["back"], secondaryMuscles: ["biceps"], category: "Machine", movementPattern: "Pull", difficulty: "Beginner", isCustom: false },
      { name: "Cable Straight Arm Pulldown", primaryMuscles: ["back"], secondaryMuscles: ["triceps"], category: "Cable", movementPattern: "Pull", difficulty: "Intermediate", isCustom: false },
      ...
      { name: "Machine Lateral Raise", primaryMuscles: ["shoulders"], secondaryMuscles: [], category: "Machine", movementPattern: "Push", difficulty: "Beginner", isCustom: false },
      { name: "Dumbbell Shrug", primaryMuscles: ["traps"], secondaryMuscles: [], category: "Dumbbell", movementPattern: "Pull", difficulty: "Beginner", isCustom: false },
      { name: "Cable Shrug", primaryMuscles: ["traps"], secondaryMuscles: [], category: "Cable", movementPattern: "Pull", difficulty: "Beginner", isCustom: false },
