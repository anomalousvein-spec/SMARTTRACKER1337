...
export const MUSCLE_MAPPING: Record<string, { primary: string; secondary?: string[] }> = {
  ...
  'hammer strength chest press': { primary: 'chest', secondary: ["triceps", "shoulders"] },
  'dumbbell incline fly': { primary: 'chest', secondary: ["shoulders"] },
  'smith machine decline press': { primary: 'chest', secondary: ["triceps", "shoulders"] },
  ...
  'goblet squat': { primary: 'quads', secondary: ["glutes", "hamstrings"] },
  'adductor machine': { primary: 'quads' },
  'abductor machine': { primary: 'glutes' },
  'v-bar pulldown': { primary: 'back', secondary: ["biceps"] },
  'single arm lat pulldown': { primary: 'back', secondary: ["biceps"] },
  'chest supported row': { primary: 'back', secondary: ["biceps"] },
  'cable straight arm pulldown': { primary: 'back', secondary: ["triceps"] },
  ...
  'machine lateral raise': { primary: 'shoulders' },
  'dumbbell shrug': { primary: 'traps' },
  'cable shrug': { primary: 'traps' },
